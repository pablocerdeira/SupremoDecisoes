...
# MySQL settings
global MySQLhost =     '172.16.4.51'
global MySQLusername = 'pablocerdeira'
global MySQLpasswd =   'pablo123'
global MySQLdb =       'fredericodba'

# Rows limit when reading/writing from/to MySQL
global MySQLLimit =    'limit 0,1000'
...
global ta_main =               "ta_main"
global ta_main_source =        'monocraticas'
global ta_main_idx =           ['num_processo','ministro']


# Table: Analysis Words All
# Define table name, table columns and table indexes (idx)
global ta_words_all =          "ta_words_all"           
global ta_word_all_columns =   ['id int not null auto_increment',
                                'id_monocratica int null',
                                'word varchar(255) null',
                                'word_count int null'
                                ]
global ta_words_all_idx =       ['id_monocratica','word','word_count']

# Export plain texts decisions saving it to disk
global exporToDisk = False
global exportFolder = '/home/pablocerdeira/corpora/decisoes_supremo/'
